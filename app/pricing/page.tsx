        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-black/60">
              <span>Monthly</span>
              <span className="px-2 py-1 bg-black/5 text-xs font-medium">Save 20%</span>
              <span>Annual</span>
            </div>
          </div>
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <Link
                  ...
                  className={`block w-full text-center px-4 py-2.5 text-sm font-medium transition-all duration-300 shadow-sm hover:shadow-md ${
          ...
          <div className="mb-12">
            ...
            <div className="max-w-3xl mx-auto space-y-3">
              {faqs.map((faq, index) => (
                <div key={index} className="border border-black/5 p-4 bg-white/30">
          ...
          <div className="text-center bg-black/95 backdrop-blur-sm text-white p-8">
