    ...
    <section className="py-24 px-4" id="cta">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-black/70 border border-black/20 hover:bg-black/5 hover:border-black/40 hover:text-black transition-all duration-300"
            href="#"
          >
            Book Demo
          </a>
